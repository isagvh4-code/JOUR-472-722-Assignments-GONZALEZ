...
**Q1** Which department has the highest mean (average) number of seats for its classes? You need to show the department with the highest average first. Which one is the most surprising/interesting to you? **A1 The highest department with the highest average if sets is Computer, Math, and Natural Sciences with 440. I think that the interesting thing is**

...
**Task** Run the following code to load data. Describe what you see in the answer space below. What columns exist in this data? **Answer: There are 8 columns: Object ID, Zipcode 2, Zipcode 1, Zipname, Shape Leng, Shape Area, Existing and Geometry.**
...
**Task** Run the following code. Describe the output in the space below: what kind of information does it contain? **Answe: It contains the zipcodes of Maryland and their shape.**
...
**Task** Run the following code. Describe the output in the space below. **Answer, Is the map of the zipcodes in Maryland.**
...
**Task** Run the following code. Describe the output in the space below. **Answer: This database contains all the counties in the country.**
...
**Task** Run the following code. Describe the output in the space below. **Answer: This code filters only the counties in Maryland.**
...
**Task** Run the following code. Describe the output in the space below. **Answer: This code creates the map of the counties in Maryland.**
...
**Task** Run the following code. Describe the output in the space below. **Answer: This maps contains both maps of zipcodes in Maryland and counties in Mayland.**
...
**Task** Run the following code. Describe the output in the space below. **Answer: This code imports data from notices of intent to foreclose in Maryland by zipcode. Cleans it, and selects only the ones that happened in March 2023.**
...
**Task** Run the following code. Describe the output in the space below. **Answer: This code joins the data of foreclosures in March (using its location =zipcode) and all zipcodes in Maryland.**
...
**Task** Run the following code. Describe the output in the space below. **Answer: This code calculates first the center of the zip code shapes. Then generates a map with colores using the foreclosure data.**
...
**Task** Run the following code. Describe the output in the space below. Be sure to input your census api key. **Answer: Loads libraries.**
...
library(janitor)
library(tidycensus)
census_api_key("72a3fe9b24c244b00d5de1cec41f25301a2376dd",overwrite=TRUE,install=TRUE)
```
...
**Task** Run the following code. Describe the output in the space below. **Answer: This code restructures the original dataframe of foreclosure using date and type. And creates a new dataframe with focus on counties.**
...
**Task** Run the following code. Describe the output in the space below. **Answer: Gets data from de census by population.**
...
**Task** Run the following code. Describe the output in the space below. **Answer: makes visible the two new data frames.**
...
**Task** Run the following code. Describe the output in the space below. **Answer: This code is changing the names of the colums.**
...
**Task** Run the following code. Describe the output in the space below. **Answer: this code joins the data frame of foreclosures with the one of the county with focus in population, and organize it by rate.**
...
**Task** Run the following code. Describe the output in the space below. **Answer: Now we can see which counties with more population have more foreclosures.**
...
**Task** Run the following code. Describe the output in the space below. **Answer: This combines the zip code map and the foreclosure rates.**
...
**Task** Run the following code. Describe the output in the space below. What regional patterns do you see? **Answer: The maps** **demostrates that there are more foreclosures in the metropolitan areas,**

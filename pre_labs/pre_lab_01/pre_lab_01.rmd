...
**Answer: Groups by term and summarize by the number of clasess**
...
Compared to the previous codeblock, what has changed and how did that affect the result? **Answer:** **It changed the order based on the number of classes.**
...
**Answer: Now the classes are also group by department.**
...
1.  What are the most in-demand classes?

2.  Which professor teaches the most classes?

3.  What department has the most in-demand classes?

...
```{r echo=FALSE}
#census_api_key("72a3fe9b24c244b00d5de1cec41f25301a2376dd", install=TRUE)
```
...
**Task** What is another question you could ask of this data? **Answer:** Is the average college enrollment rate of high schools located in ZIP codes where the Hispanic or Latino population is the demographic majority different compared to high schools in ZIP codes where it's not?

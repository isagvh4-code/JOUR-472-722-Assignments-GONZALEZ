...
**Task** Run the following code. Explain what you see after running the code in the space below. What has changed from the last codeblock? **Answer It has more information in the graphic than before.**
...
**Task** Run the following code. Explain what you see after running the code in the space below. **Answer It group Baltimore's 911 calls for overdose by date.**
...
**Task** Run the following code. Explain what you see after running the code in the space below. **Answer You can see a graphic of the distribution of the calls by dates.**
...
**Task** Run the following code. Explain what you see after running the code in the space below. **Answer It makes a different scale (per week) of the data distribution by date.**
...
**Task** Run the following code. Explain what you see after running the code in the space below. **Answer Now it has a different theme. It modify the angle of the labels so you can see more clear the data, making it more readable.**

...
evans_response <- axolotr::ask(
  prompt = paste("Given the following text, extract information into a CSV file with the following structure, including headers, with no yapping, no backlashes: celebrant1,celebrant2,location_city, location_state,officiant,celebrant1_age,celebrant2_age,celebrant1_parent1,celebrant1_parent2,celebrant2_parent1,celebrant2_parent2", text),
  model = "llama-3.1-8b-instant"
)
...
```{r}
class_groq <- axolotr::ask(
  prompt = "What is the best way to really learn how to use RStudio to make journalism if I am in a class about the program? Give me tips to learn faster",
  model = "llama-3.1-8b-instant"
)
...
**Your comment: I like the tips that R is telling me too learn R better, specially the one that says we should apply the knowledge in R to real-world problems. I think that some of the tips that R says are in the same logic as the professor.**
